...
public class hotaldetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotaldetails);
                ...
                fAuth.signInWithEmailAndPassword (mail,password).addOnCompleteListener (new OnCompleteListener<AuthResult> () {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful ()){
                            ...
                            TastyToast.makeText (hotaldetails.this,"Error !"+task.getException ().getMessage (), TastyToast.LENGTH_LONG, TastyToast.ERROR).show ();
                    ...
                    public void onClick(DialogInterface dialog ,int which) {
                        ...
                        fAuth.sendPasswordResetEmail (mail).addOnSuccessListener (new OnSuccessListener<Void> () {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText (hotaldetails .this,"Reset Link Sent To Your Mail",Toast.LENGTH_SHORT).show ();

                            }
                        }).addOnFailureListener (new OnFailureListener () {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText (hotaldetails .this,"Error Reset Link is not Sent "+e.getMessage (),Toast.LENGTH_SHORT).show ();
                            }
                        });
