...
public class creatacountforhotalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_creatacountforhotal);
                ...
                fAuth.createUserWithEmailAndPassword (mail,password).addOnCompleteListener (new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful ()){
                            ...
                            TastyToast.makeText (creatacountforhotalActivity.this,"Error !"+task.getException ().getMessage (), TastyToast.LENGTH_LONG, TastyToast.ERROR).show ();
        ...
        Haccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent (creatacountforhotalActivity.this ,hotaldetails.class));
