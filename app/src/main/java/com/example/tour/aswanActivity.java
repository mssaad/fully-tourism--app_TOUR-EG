                ...
                fAuth.signInWithEmailAndPassword (mail,password).addOnCompleteListener (new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful ()){
                            ...
                            startActivity(new Intent(getApplicationContext (),roomaswanActivity.class));
                        }
                        else {
                            TastyToast.makeText (aswanActivity.this,"Error !"+task.getException ().getMessage (), TastyToast.LENGTH_LONG, TastyToast.ERROR).show ();
                    ...
                    public void onClick(DialogInterface dialog ,int which) {
                        ...
                        fAuth.sendPasswordResetEmail (mail).addOnSuccessListener (new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText (aswanActivity .this,"Reset Link Sent To Your Mail",Toast.LENGTH_SHORT).show ();

                            }
                        }).addOnFailureListener (new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText (aswanActivity .this,"Error Reset Link is not Sent "+e.getMessage (),Toast.LENGTH_SHORT).show ();
                            }
                        });
